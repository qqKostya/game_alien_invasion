...
class AlienInvasion:
    ...
    def _update_bullets(self):
        """Обновляет позиции снарядов и уничтожат старые снаряды."""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Удаление снарядов и прицельцев, участвующих в коллизиях.
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            # Уменьшает ships_left и обновление панели счета.
    ...
    def _create_fleet(self):
        ...
        # Создание пришельца и вычесление количества пришельце в ряду
    ...
    def _update_screen(self):
        """Обновляет ищображение на экране и отображает новый экран."""
        ...
        # Кнопка Play отоброжаеться в тома случае, если игра неактивна.
